...
const KYCSchema = new mongoose.Schema({
    ...
    verification: {
        ...
        currentStep: { type: Number, default: 1 }, // 1-5 steps
        submittedAt: Date,
        verifiedAt: Date,
        rejectedAt: Date,
        rejectReason: String,
    ...
    autoVerification: {
        ...
        documentQuality: { type: Number, default: 0 }, // 0-100 score
        ocrConfidence: { type: Number, default: 0 }, // 0-100 score
